...
/**
 * Shared login UI used by both /login (public-ish test mode) and
 * /devlogin (full developer pad with super-admin). Visible accounts
 * are controlled by the caller via the \`accounts\` prop.
 */
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#fff" }}>
      <header className="px-5 py-3.5 flex items-center justify-between" style={{ background: "#A6192E" }}>
        <span className="text-white text-xs font-bold tracking-[0.25em] uppercase">Seattle Academy</span>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-10">
        <div className="w-full max-w-sm">
          <div className="flex flex-col items-center mb-8">
            <Image src="/images/SAASLogo.png" alt="SAAS Seattle Academy"
                   width={220} height={73} priority className="h-auto mb-4" />
          ...
          {error && (
            <div className="mb-4 px-4 py-3 rounded-xl text-xs font-semibold text-center"
