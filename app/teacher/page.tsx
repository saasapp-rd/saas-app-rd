...
const ROSTER = [
  { id: 1, name: "Doe, Jane",    grade: 10, selected: false },
  { id: 2, name: "Kim, Alex",    grade: 10, selected: false },
  { id: 3, name: "Lee, Marcus",  grade: 10, selected: false },
  { id: 4, name: "Smith, John",  grade: 11, selected: false },
  { id: 5, name: "Torres, Maya", grade: 10, selected: false },
  { id: 6, name: "Walsh, Chris", grade: 11, selected: false },
]
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#fff" }}>
      ...
      <main className="flex-1 flex flex-col px-5 py-5 gap-4 max-w-lg mx-auto w-full">
        <div>
          ...
          <p className="text-xs mt-0.5" style={{ color: "#3D3D3D", opacity: 0.5 }}>Tap a student to mark them missing from your class</p>
        </div>
