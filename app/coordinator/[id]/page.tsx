...
export default async function IncidentPage({
  ...
  const student  = norm<{ id: string; first_name: string; last_name: string; grade: number; veracross_id: string | null }>(inc.student)
      ...
      <main className="flex-1 px-5 py-5 max-w-lg mx-auto w-full flex flex-col gap-5">
        ...
        <div>
          ...
          <StepActions incident={{
            ...
            located_location:    inc.located_location  ?? null,
          }} />
        </div>
